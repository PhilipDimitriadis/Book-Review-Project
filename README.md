...
* Book Search: User searches books via Open Library API
* Book Details: App fetches detailed book information from Open Library
* Authentication: User logs in, receives token stored in localStorage
